...
(let ((ex-bg      "#1c1b17")
  ...
  (custom-theme-set-faces
   ...
   `(cursor            ((t (:background ,ex-type))))
   `(vertical-border   ((t (:foreground ,ex-line))))
   `(minibuffer-prompt ((t (:foreground ,ex-main))))
   ...
   `(link-visited      ((t (:foreground ,ex-main :underline t))))
   ...
   `(match ((t ,(list :background ex-main :foreground ex-line))))
   
   `(help-key-binding          ((t ,(list :background ex-main :foreground ex-bg))))
   `(read-multiple-choice-face ((t ,(list :background ex-main :foreground ex-bg))))
   ...
   `(lazy-highlight ((t (:background ,ex-main :foreground ,ex-bg))))

   ;; //////////////////////////
   ;; font lock faces ----------
   `(font-lock-bracket-face              ((t (:foreground ,ex-fg))))
   `(font-lock-builtin-face              ((t (:foreground ,ex-main))))
   `(font-lock-comment-delimiter-face    ((t (:foreground ,ex-gray))))
   `(font-lock-comment-face              ((t (:foreground ,ex-gray))))
   `(font-lock-constant-face             ((t (:foreground ,ex-main))))
   `(font-lock-delimiter-face            ((t (:foreground ,ex-fg))))
   `(font-lock-doc-face                  ((t (:foreground ,ex-main))))
   `(font-lock-doc-markup-face           ((t (:foreground ,ex-main))))
   ...
   `(font-lock-keyword-face              ((t (:foreground ,ex-main :bold nil))))
   ;;`(font-lock-keyword-face              ((t (:foreground ,ex-type :bold nil))))
   ...
   `(font-lock-string-face               ((t (:foreground ,ex-string))))
   ;;`(font-lock-type-face                 ((t (:foreground ,ex-type :bold nil))))
   `(font-lock-type-face                 ((t (:foreground ,ex-main :bold nil))))
   `(font-lock-variable-name-face        ((t (:foreground ,ex-fg))))
   `(font-lock-variable-use-face         ((t (:foreground ,ex-fg))))
   `(font-lock-warning-face              ((t (:foreground ,ex-main))))
   ...
   `(isearch-fail ((t (:foreground ,ex-bg :background ,ex-main :bold t))))

   ;; ++ pulse -----------------
   `(pulse-highlight-start-face ((t (:background ,ex-white))))
   
   ;; ++ dired -----------------
   `(warning ((t (:background nil :foreground ,ex-type))))
   
   ;; ++ show paren ------------
   `(show-paren-match            ((t (:background ,ex-fg :foreground ,ex-bg))))
   `(show-paren-match-expression ((t (:background ,ex-fg :foreground ,ex-bg))))
   `(show-paren-mismatch         ((t (:background ,ex-type :foreground ,ex-bg))))
   
   ;; ++ tree-sitter -----------
   `(tree-sitter-hl-face:embedded      ((t (:foreground ,ex-main))))
   `(tree-sitter-hl-face:function.call ((t (:foreground ,ex-gray :italic nil))))
   ;;`(tree-sitter-hl-face:type          ((t (:foreground ,ex-type))))
   `(tree-sitter-hl-face:type          ((t (:foreground ,ex-main))))
   `(tree-sitter-hl-face:variable      ((t (:foreground ,ex-fg))))
   `(tree-sitter-hl-face:number        ((t (:foreground ,ex-string))))
   ...
   `(ivy-minibuffer-match-face-2 ((t (:background ,ex-main :foreground ,ex-black))))
   `(ivy-minibuffer-match-face-3 ((t (:background ,ex-main :foreground ,ex-black))))
   `(ivy-minibuffer-match-face-4 ((t (:background ,ex-main :foreground ,ex-black))))
   ...
   `(swiper-background-match-face-2 ((t (:background ,ex-main :foreground ,ex-black))))
   `(swiper-background-match-face-3 ((t (:background ,ex-main :foreground ,ex-black))))
   `(swiper-background-match-face-4 ((t (:background ,ex-main :foreground ,ex-black))))

   `(swiper-match-face-1 ((t (:background ,nil :foreground ,nil))))
   `(swiper-match-face-2 ((t (:background ,ex-main :foreground ,ex-black))))
   `(swiper-match-face-3 ((t (:background ,ex-main :foreground ,ex-black))))
   `(swiper-match-face-4 ((t (:background ,ex-main :foreground ,ex-black))))
   ))
