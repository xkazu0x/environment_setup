(deftheme excalibur-green-hard "EXCALIBUR")
...
(let ((ex-bg      "#1c1b17")
  ...
  (custom-theme-set-faces
   ...
   `(compilation-error   ((t (:foreground ,ex-light))))
   ...
   ;; //////////////////////////
   ;; line number --------------
   `(line-number              ((t (:background ,ex-black :foreground ,ex-gray))))
   `(line-number-current-line ((t (:background ,ex-black :foreground ,ex-fg))))

   ;; //////////////////////////
   ;; hl-line ------------------
   `(hl-line        ((t (:background ,ex-hl-line))))
   ...
   `(font-lock-comment-delimiter-face    ((t (:foreground ,ex-comment))))
   `(font-lock-comment-face              ((t (:foreground ,ex-comment))))
